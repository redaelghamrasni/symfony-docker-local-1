...
function createAutocompletePropGetters(param) {
    ...
    return function usePropGetters(param) {
        ...
        var _useState = _(useState(autoFocus), 2), isOpen = _useState[0], setIsOpen = _useState[1];
        var _useState1 = _(useState(undefined), 2), activeDescendant = _useState1[0], setActiveDescendant = _useState1[1];
 ...
 */ function unwrapRef(ref) {
    return ref.current && _$1(ref.current) === 'object' && 'base' in ref.current ? ref.current.base // Preact
     : ref.current; // React
}

export { createAutocompletePropGetters };
