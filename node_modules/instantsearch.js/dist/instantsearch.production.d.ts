...
declare type AutocompleteWidgetParams<TItem extends BaseHit> = IndicesAutocompleteWidgetParams<TItem> | FeedsAutocompleteWidgetParams<TItem>;

declare type BaseAutocompleteWidgetParams<TItem extends BaseHit> = {
    /**
     * CSS Selector or HTMLElement to insert the widget.
     */
    container: string | HTMLElement;
...
declare function EXPERIMENTAL_autocomplete<TItem extends BaseHit = BaseHit>(widgetParams: AutocompleteWidgetParams<TItem> & AutocompleteConnectorParams): (({
    parent?: IndexWidget;
    $$type: string;
    init?: (options: InitOptions) => void;
    shouldRender?: (options: ShouldRenderOptions) => boolean;
    ...
    getWidgetRenderState?: ((renderOptions: InitOptions | RenderOptions) => Expand<WidgetRenderState<unknown, unknown>>) | undefined;
    getRenderState?: ((renderState: {
        answers?: WidgetRenderState<AnswersRenderState, AnswersConnectorParams> | undefined;
        autocomplete?: WidgetRenderState<AutocompleteRenderState, AutocompleteConnectorParams> | undefined;
        breadcrumb?: {
        ...
        analytics?: WidgetRenderState<Record<string, unknown>, AnalyticsWidgetParams> | undefined;
        places?: WidgetRenderState<Record<string, unknown>, PlacesWidgetParams> | undefined;
    }, renderOptions: InitOptions | RenderOptions) => IndexRenderState & unknown) | undefined;
} & {
    dependsOn?: "search";
    getWidgetParameters?: ((state: SearchParameters, widgetParametersOptions: {
        uiState: {
    ...
    getWidgetRenderState: (renderOptions: InitOptions | ({
        instantSearchInstance: InstantSearch;
        parent: IndexWidget;
        templatesConfig: Record<string, unknown>;
        scopedResults: ScopedResult[];
        ...
        results: RecommendResponse_2<any>;
    })) => Expand<WidgetRenderState<unknown, unknown>>;
}))[];
...
declare type FeedConfig<TItem extends BaseHit> = {
    /**
...
declare type FeedsAutocompleteWidgetParams<TItem extends BaseHit> = BaseAutocompleteWidgetParams<TItem> & {
    /**
...
declare type FeedsShowPromptSuggestionsWidgetParams = {
    feedID: string;
    getURL?: IndexConfig<{
        query: string;
        label?: string;
    }>['getURL'];
    templates?: IndexConfig<{
        query: string;
        label?: string;
    }>['templates'];
    cssClasses?: Partial<AutocompleteIndexClassNames>;
...
declare type FeedsShowQuerySuggestionsWidgetParams = {
    feedID: string;
    getURL?: IndexConfig<{
        query: string;
    }>['getURL'];
...
declare type IndicesAutocompleteWidgetParams<TItem extends BaseHit> = BaseAutocompleteWidgetParams<TItem> & {
    /**
...
declare type IndicesShowPromptSuggestionsWidgetParams = Partial<Pick<IndexConfig<{
    query: string;
    label?: string;
}>, 'indexName' | 'getURL' | 'templates' | 'cssClasses' | 'searchParameters'>>;

declare type IndicesShowQuerySuggestionsWidgetParams = Partial<Pick<IndexConfig<{
    query: string;
}>, 'indexName' | 'getURL' | 'templates' | 'cssClasses' | 'searchParameters'>>;
