...
_export(exports, {
    ...
    get tryParseErrorMessage () {
        return tryParseErrorMessage;
    }
});
...
var GuardrailViolationError = /*#__PURE__*/ function(Error1) {
    _inherits._(GuardrailViolationError, Error1);
    function GuardrailViolationError(message) {
        _class_call_check._(this, GuardrailViolationError);
        var _this;
        _this = _call_super._(this, GuardrailViolationError, [
            message
        ]);
...
function tryParseErrorMessage(text) {
    try {
        ...
        if (parsed && (typeof parsed === "undefined" ? "undefined" : _type_of._(parsed)) === 'object' && !Array.isArray(parsed) && typeof parsed.message === 'string') {
