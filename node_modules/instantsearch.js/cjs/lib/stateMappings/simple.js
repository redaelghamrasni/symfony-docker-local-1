    ...
    return {
        ...
        routeToState: function routeToState() {
            ...
            return Object.keys(routeState).reduce(function(state, indexId) {
                ...
                if ((typeof indexState === "undefined" ? "undefined" : _type_of._(indexState)) !== 'object' || indexState === null) {
                    return state;
                }
                return _object_spread_props._(_object_spread._({}, state), _define_property._({}, indexId, getIndexStateWithoutConfigure(indexState)));
            }, {});
        }
    };
}
