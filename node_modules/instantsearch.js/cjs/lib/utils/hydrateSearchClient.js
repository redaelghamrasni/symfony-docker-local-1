...
Object.defineProperty(exports, "hydrateSearchClient", {
    enumerable: true,
    get: function() {
        return hydrateSearchClient;
    }
});
...
function hydrateSearchClient(client, results) {
    ...
    if ('transporter' in client && !client._cacheHydrated) {
        ...
        client.search = function(requests) {
            ...
            var requestsWithSerializedParams = Array.isArray(requests) ? requests.map(function(request) {
                return _object_spread_props._(_object_spread._({}, request), {
            ...
            return client.transporter.responsesCache.get({
                ...
                ].concat(_to_consumable_array._(methodArgs))
            }, function() {
    ...
    if (!('transporter' in client)) {
        ...
        client.cache = _object_spread_props._(_object_spread._({}, client.cache), _define_property._({}, cacheKey, JSON.stringify({
...
function deserializeQueryParameters(parameters) {
    return parameters.split('&').reduce(function(acc, parameter) {
        var _parameter_split = _sliced_to_array._(parameter.split('='), 2), key = _parameter_split[0], value = _parameter_split[1];
