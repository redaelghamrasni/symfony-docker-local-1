...
function toFeedSearchResults(state, raw) {
    return Object.assign(new _algoliasearchhelper.default.SearchResults(state, [
        raw
    ]), {
        feedID: raw.feedID
    });
        ...
        return {
            ...
            getWidgetRenderState: function getWidgetRenderState(param) {
                ...
                if (Array.isArray(results.feeds) && results.feeds.length > 0 && !results.feeds.every(function(feed) {
                    return _instanceof._(feed, _algoliasearchhelper.default.SearchResults);
                })) {
                    results.feeds = results.feeds.map(function(feed) {
                        return _instanceof._(feed, _algoliasearchhelper.default.SearchResults) ? feed : toFeedSearchResults(results._state, feed);
                    });
                }
