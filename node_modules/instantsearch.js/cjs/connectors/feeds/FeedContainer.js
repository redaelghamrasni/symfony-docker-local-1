...
Object.defineProperty(exports, "createFeedContainer", {
    enumerable: true,
    get: function() {
        return createFeedContainer;
    }
});
...
function createFeedContainer(feedID, parentIndex, instantSearchInstance) {
    ...
    var container = {
            ...
            if (initialized) {
                flatWidgets.forEach(function(widget) {
                    if (widget.getRenderState) {
                        var renderState = widget.getRenderState(instantSearchInstance.renderState[container.getIndexId()] || {}, (0, _utils.createInitArgs)(instantSearchInstance, container, instantSearchInstance._initialUiState));
                        (0, _utils.storeRenderState)({
                ...
                flatWidgets.forEach(function(widget) {
                    if (widget.init) {
                        widget.init((0, _utils.createInitArgs)(instantSearchInstance, container, instantSearchInstance._initialUiState));
                    }
                });
        ...
        removeWidgets: function removeWidgets(widgets) {
            ...
            flatWidgets.forEach(function(widget) {
                if (widget.dispose) {
                    ...
                    if (_instanceof._(next, _algoliasearchhelper.default.RecommendParameters)) ; else if (next) {
                        cleanedState = next;
                    }
                }
            });
        ...
        render: function render() {
            localWidgets.forEach(function(widget) {
                if (widget.getRenderState) {
                    var renderState = widget.getRenderState(instantSearchInstance.renderState[container.getIndexId()] || {}, (0, _utils.createRenderArgs)(instantSearchInstance, container, widget));
                    (0, _utils.storeRenderState)({
                        renderState: renderState,
                        instantSearchInstance: instantSearchInstance,
                        parent: container
            ...
            localWidgets.forEach(function(widget) {
                if (widget.render) {
                    widget.render((0, _utils.createRenderArgs)(instantSearchInstance, container, widget));
                }
            });
        },
