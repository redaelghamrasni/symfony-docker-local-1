    ...
    return function(widgetParams) {
        ...
        return {
            ...
            init: function init(initOptions) {
                ...
                (0, _utils.warning)(isCurrentIndexInItems !== undefined, 'The index named "'.concat(currentIndex, '" is not listed in the `items` of `sortBy`.'));
            ...
            getWidgetSearchParameters: function getWidgetSearchParameters(searchParameters, param) {
                ...
                (0, _utils.warning)(Boolean(isUiStateSortByInItems), 'The index named "'.concat(uiState.sortBy, '" is not listed in the `items` of `sortBy`.'));
