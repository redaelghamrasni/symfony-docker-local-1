...
var aiModeSuit = (0, _suit.component)('AiModeButton');
var renderer = function renderer(param) {
    ...
    return function(param) {
        ...
        var onAiModeClick = aiMode ? function(currentQuery) {
            if ((0, _chat.openChat)(getChatRenderState(), {
        ...
        var aiModeButtonDisabled = aiMode ? (0, _chat.isChatBusy)(getChatRenderState()) : undefined;
...
var searchBox = function searchBox(widgetParams) {
    ...
    var cssClasses = {
        ...
        aiModeButton: (0, _instantsearchuicomponents.cx)(aiModeSuit(), userCssClasses.aiModeButton),
        aiModeIcon: (0, _instantsearchuicomponents.cx)(aiModeSuit({
            descendantName: 'icon'
        }), userCssClasses.aiModeIcon),
        aiModeLabel: (0, _instantsearchuicomponents.cx)(aiModeSuit({
    ...
    var widgetFactory = (0, _connectSearchBox.default)(specializedRenderer, function() {
        (0, _preact.render)(null, containerNode);
    });
    return _object_spread._(_object_spread_props._(_object_spread._({}, widgetFactory({
        queryHook: queryHook
    })), {
