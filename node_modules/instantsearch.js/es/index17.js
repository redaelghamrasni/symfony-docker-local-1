...
import { _ as _$5 } from '@swc/helpers/esm/_instanceof.js';
...
import { addWidgetId } from './index34.js';
...
import { isIndexWidget } from './index21.js';
import { defer } from './index12.js';
import { createDocumentationMessageGenerator } from './index22.js';
import { mergeSearchParameters } from './index41.js';
import { createInitArgs, storeRenderState, createRenderArgs } from './index43.js';
import { resolveSearchParameters } from './index44.js';
...
function getLocalWidgetsSearchParameters(widgets, widgetSearchParametersOptions) {
    var initialSearchParameters = widgetSearchParametersOptions.initialSearchParameters, rest = _$4(widgetSearchParametersOptions, [
...
function getLocalWidgetsRecommendParameters(widgets, widgetRecommendParametersOptions) {
    var initialRecommendParameters = widgetRecommendParametersOptions.initialRecommendParameters, rest = _$4(widgetRecommendParametersOptions, [
...
function resolveScopedResultsFromWidgets(widgets) {
    ...
    return indexWidgets.reduce(function(scopedResults, current) {
        ...
        ].concat(_$1(resolveScopedResultsFromWidgets(current.getWidgets()))));
    }, []);
}
    ...
    return {
        ...
        createURL: function createURL(nextState) {
            if (typeof nextState === 'function') {
                return localInstantSearchInstance._createURL(_({}, indexId, nextState(localUiState)));
            }
            return localInstantSearchInstance._createURL(_({}, indexId, getLocalWidgetsUiState(localWidgets, {
        ...
        removeWidgets: function removeWidgets(widgets) {
            ...
            if (localInstantSearchInstance && Boolean(flatWidgets.length)) {
                var _flatWidgets_reduce = flatWidgets.reduce(function(states, widget) {
                    ...
                    if (_$5(next, algoliasearchHelper.RecommendParameters)) {
        ...
        init: function init(param) {
            ...
            helper.searchForFacetValues = function(facetName, facetValue, maxFacetHits, userState) {
                var state = mergeSearchParameters.apply(void 0, [
                    mainHelper.state
                ].concat(_$1(resolveSearchParameters(_this)))).setQueryParameters(userState);
            ...
            derivedHelper = derivingHelper.derive(function() {
                return mergeSearchParameters.apply(void 0, [
                    mainHelper.state
                ].concat(_$1(resolveSearchParameters(_this))));
            }, function() {
            ...
            localWidgets.forEach(function(widget) {
                if (widget.getRenderState) {
                    var renderState = widget.getRenderState(instantSearchInstance.renderState[_this.getIndexId()] || {}, createInitArgs(instantSearchInstance, _this, uiState));
                    storeRenderState({
                        renderState: renderState,
                        instantSearchInstance: instantSearchInstance,
                        parent: _this
            ...
            localWidgets.forEach(function(widget) {
                if (widget.init) {
                    widget.init(createInitArgs(instantSearchInstance, _this, uiState));
                }
            });
        ...
        render: function render(param) {
            ...
            widgetsToRender.forEach(function(widget) {
                if (widget.getRenderState) {
                    var renderState = widget.getRenderState(instantSearchInstance.renderState[_this.getIndexId()] || {}, createRenderArgs(instantSearchInstance, _this, widget));
                    storeRenderState({
                        renderState: renderState,
                        instantSearchInstance: instantSearchInstance,
                        parent: _this
            ...
            widgetsToRender.forEach(function(widget) {
                ...
                if (widget.render) {
                    widget.render(createRenderArgs(instantSearchInstance, _this, widget));
                }
            });
        },
        ...
        getWidgetUiState: function getWidgetUiState(uiState) {
            ...
            }, _$2(_$3({}, uiState), _({}, indexId, _$3({}, uiState[indexId], localUiState))));
        },
        ...
        setIndexUiState: function setIndexUiState(indexUiState) {
            ...
            localInstantSearchInstance.setUiState(function(state) {
                return _$2(_$3({}, state), _({}, indexId, nextIndexUiState));
            });
        }
    };
};
