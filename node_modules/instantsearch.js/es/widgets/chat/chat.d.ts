...
import { SearchIndexToolType, RecommendToolType, DisplayResultsToolType } from '../../lib/chat';
...
import type { ChatClassNames, ChatHeaderProps, ChatLayoutOwnProps, ChatMessageActionProps, ChatMessageBase, ChatMessageErrorProps, ChatEmptyProps, ChatMessageLoaderProps, ChatPromptProps, ClientSideToolComponentProps, ClientSideTools, RecordWithObjectID, UserClientSideTool } from 'instantsearch-ui-components';
...
export type ChatLayoutTemplateData = Omit<ChatLayoutOwnProps, 'headerComponent' | 'messagesComponent' | 'promptComponent'> & {
    templates: {
        header: () => JSX.Element;
...
declare const _default: <THit extends RecordWithObjectID = RecordWithObjectID>(widgetParams: ChatWidgetParams<THit> & ChatConnectorParams) => {
    ...
    getRenderState(renderState: {
        ...
        feeds?: import("../../connectors/feeds/connectFeeds").FeedsRenderState | undefined;
