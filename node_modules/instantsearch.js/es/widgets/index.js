...
export { EXPERIMENTAL_autocomplete } from './autocomplete/autocomplete.js';
...
export { default as feeds } from './feeds/feeds.js';
...
export { default as trendingFacets } from './trending-facets/trending-facets.js';
...
export { default as chatTrigger } from './chat-trigger/chat-trigger.js';
...
/** @deprecated answers is no longer supported */ var EXPERIMENTAL_answers = deprecate(answers);
/** @deprecated use relatedItems instead */ var EXPERIMENTAL_configureRelatedItems = deprecate(configureRelatedItems);
/** @deprecated use dynamicWidgets */ var EXPERIMENTAL_dynamicWidgets = deprecate(dynamicWidgets);

export { EXPERIMENTAL_answers, EXPERIMENTAL_configureRelatedItems, EXPERIMENTAL_dynamicWidgets, dynamicWidgets };
