import type { Connector, TransformItems, Renderer, Unmounter, UnknownWidgetParams, RecommendResponse } from '../../types';
...
export type TrendingFacetsConnector = Connector<TrendingFacetsWidgetDescription, TrendingFacetsConnectorParams>;
declare const _default: <TWidgetParams extends UnknownWidgetParams>(renderFn: Renderer<TrendingFacetsRenderState, TWidgetParams & TrendingFacetsConnectorParams>, unmountFn?: Unmounter) => (widgetParams: TWidgetParams & TrendingFacetsConnectorParams) => {
    dependsOn: "recommend";
    $$type: "ais.trendingFacets";
    ...
    getRenderState(renderState: {
        ...
        feeds?: import("../feeds/connectFeeds").FeedsRenderState | undefined;
