...
export type InferUIMessageTools<T extends UIMessage> = T extends UIMessage<unknown, any, infer TOOLS> ? TOOLS : UITools;
...
type ToolUIMessageChunk<TOOLS extends UITools> = ValueOf<{
    [NAME in keyof TOOLS & string]: {
...
export type UIMessageChunk<METADATA = unknown, DATA_TYPES extends UIDataTypes = UIDataTypes, TOOLS extends UITools = UITools> = {
    type: 'text-start';
    id: string;
    providerMetadata?: ProviderMetadata;
} | {
...
export type InferUIMessageChunk<T extends UIMessage> = UIMessageChunk<InferUIMessageMetadata<T>, InferUIMessageData<T>, InferUIMessageTools<T>>;
