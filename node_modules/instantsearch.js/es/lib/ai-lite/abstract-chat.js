...
import { SerialJobExecutor, GuardrailViolationError, tryParseErrorMessage, generateId } from './utils.js';
 ...
 */ var AbstractChat = /*#__PURE__*/ function() {
    function AbstractChat(param) {
        ...
        _$2(this, "conversationId", void 0);
        ...
        _$2(this, "shouldRepairToolInput", void 0);
                            ...
                            case 'tool-input-delta':
                                {
                                    ...
                                    var nextToolPart = _$7(_$3({}, existingPart !== null && existingPart !== void 0 ? existingPart : {
                                        type: "tool-".concat(chunk.toolName),
                                        toolCallId: chunk.toolCallId
                                    }), {
                                        state: 'input-streaming',
                            ...
                            case 'data-tool-output-delta':
                                {
                                    ...
                                    var nextToolPart1 = _$7(_$3({}, existingPart1 !== null && existingPart1 !== void 0 ? existingPart1 : {
                            ...
                            case 'tool-output-available':
                                {
                                    ...
                                    if (toolIndex2 >= 0) {
                                        ...
                                        var updatedParts7 = _$4(currentMessage.parts);
                                        var existingPart2 = updatedParts7[toolIndex2];
                                        // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                        var _ignored = existingPart2.rawOutput, rest = _$6(existingPart2, [
                                            "rawOutput"
                                        ]);
                                        updatedParts7[toolIndex2] = _$7(_$3({}, rest), {
                                            state: 'output-available',
                                            output: chunk.output,
                                            callProviderMetadata: chunk.callProviderMetadata,
                            ...
                            case 'tool-input-error':
                                {
                                    ...
                                    var _ref5 = existingPart3 !== null && existingPart3 !== void 0 ? existingPart3 : {}, // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredOutput = _ref5.output, // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredRawOutput = _ref5.rawOutput, // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredPreliminary = _ref5.preliminary, carryOver = _$6(_ref5, [
                                        "output",
                                        "rawOutput",
                                        "preliminary"
                                    ]);
                                    var nextToolPart2 = _$7(_$3({}, carryOver), {
                                        type: "tool-".concat(chunk.toolName),
                                        toolCallId: chunk.toolCallId,
                                        state: 'output-error',
                                        input: undefined,
                                    ...
                                    if (toolIndex3 >= 0) {
                                        var updatedParts8 = _$4(currentMessage.parts);
                            ...
                            case 'tool-output-error':
                                {
                                    ...
                                    delete toolRawInputByCallId[chunk.toolCallId];
                                    delete toolRawOutputByCallId[chunk.toolCallId];
                                    var updatedParts9 = _$4(currentMessage.parts);
                                    var existingPart4 = updatedParts9[toolIndex4];
                                    var // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredRawOutput1 = existingPart4.rawOutput, // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredPreliminary1 = existingPart4.preliminary, // eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars
                                    _ignoredOutput1 = existingPart4.output, rest1 = _$6(existingPart4, [
                                        "rawOutput",
                                        "preliminary",
                                        "output"
                                    ]);
                                    updatedParts9[toolIndex4] = _$7(_$3({}, rest1), {
                                        state: 'output-error',
                                        errorText: chunk.errorText,
