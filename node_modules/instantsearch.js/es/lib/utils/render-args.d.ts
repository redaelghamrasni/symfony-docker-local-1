import type { InstantSearch, UiState, Widget, IndexWidget, IndexRenderState } from '../../types';
...
export declare function storeRenderState({ renderState, instantSearchInstance, parent, }: {
