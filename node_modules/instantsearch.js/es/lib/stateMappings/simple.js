...
function getIndexStateWithoutConfigure(uiState) {
    uiState.configure; var trackedUiState = _$4(uiState, [
        "configure"
    ]);
    ...
    return {
        ...
        routeToState: function routeToState() {
            ...
            return Object.keys(routeState).reduce(function(state, indexId) {
                ...
                if ((typeof indexState === "undefined" ? "undefined" : _$3(indexState)) !== 'object' || indexState === null) {
                    return state;
                }
                return _(_$1({}, state), _$2({}, indexId, getIndexStateWithoutConfigure(indexState)));
            }, {});
        }
    };
}
