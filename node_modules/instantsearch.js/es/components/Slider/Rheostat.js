...
import { _ as _$4 } from '@swc/helpers/esm/_class_call_check.js';
import { _ } from '@swc/helpers/esm/_define_property.js';
import { _ as _$3 } from '@swc/helpers/esm/_inherits.js';
...
function Button(props) {
    return /*#__PURE__*/ h("button", _$1(_$2({}, props), {
        type: "button"
    }));
}
var Rheostat = /*#__PURE__*/ function(Component) {
    _$3(Rheostat, Component);
    function Rheostat() {
        _$4(this, Rheostat);
        var _this;
        _this = _$5(this, Rheostat, arguments), _(_this, "x", [
            0,
            0
        ].map(function(y) {
            return y;
        ...
        }), _(_this, "rheostat", createRef()), _(_this, "componentWillReceiveProps", function(nextProps) {
        ...
        }), _(_this, "getPublicState", function() {
        ...
        }), _(_this, "getSliderBoundingBox", function() {
        ...
        }), _(_this, "getProgressStyle", function(idx) {
        ...
        }), _(_this, "getNextPositionForKey", function(idx, keyCode) {
            ...
            var _obj;
            var stepMultiplier = (_obj = {}, _(_obj, KEYS.LEFT, function(v) {
                return v * -1;
            }), _(_obj, KEYS.RIGHT, function(v) {
                return v;
            }), _(_obj, KEYS.UP, function(v) {
                return v;
            }), _(_obj, KEYS.DOWN, function(v) {
                return v * -1;
            }), _(_obj, KEYS.PAGE_DOWN, function(v) {
                return v > 1 ? -v : v * -10;
            }), _(_obj, KEYS.PAGE_UP, function(v) {
                return v > 1 ? v : v * 10;
            }), _obj);
        ...
        }), _(_this, "getNextState", function(idx, proposedPosition) {
            var handlePos = _this.state.handlePos;
            var _this_props = _this.props, max = _this_props.max, min = _this_props.min;
        ...
        }), _(_this, "getClosestHandle", function(positionPercent) {
            var handlePos = _this.state.handlePos;
        ...
        }), _(_this, "setStartSlide", function(ev, x, y) {
        ...
        }), _(_this, "startMouseSlide", function(ev) {
            ...
            killEvent(ev);
        }), _(_this, "startTouchSlide", function(ev) {
            ...
            killEvent(ev);
        }), _(_this, "handleSlide", function(x, y) {
        ...
        }), _(_this, "handleClick", function(ev) {
        ...
        }), _(_this, "handleKeydown", function(ev) {
        ...
        _(_this, "validatePosition", function(idx, proposedPosition) {
        ...
        }), _(_this, "validateValues", function(proposedValues, props) {
        ...
        }), _(_this, "canMove", function(idx, proposedPosition) {
            var _this_state = _this.state, handlePos = _this_state.handlePos, handleDimensions = _this_state.handleDimensions;
            ...
            return true;
        }), _(_this, "fireChangeEvent", function() {
            var onChange = _this.props.onChange;
            if (onChange) onChange(_this.getPublicState());
        }), _(_this, "slideTo", function(idx, proposedPosition, onAfterSet) {
        ...
        }), _(_this, "updateNewValues", function(nextProps) {
            ...
            return /*#__PURE__*/ h("div", {
                ...
                return /*#__PURE__*/ h(PitComponent, {
                    key: "pit-".concat(n),
                    style: pitStyle
                }, n);
            }), children);
