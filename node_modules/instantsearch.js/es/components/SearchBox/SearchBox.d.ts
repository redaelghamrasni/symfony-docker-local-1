...
export type SearchBoxComponentCSSClasses = ComponentCSSClasses<Omit<SearchBoxCSSClasses, 'aiModeButton' | 'aiModeIcon' | 'aiModeLabel'>> & {
    aiModeButton?: string;
    aiModeIcon?: string;
    aiModeLabel?: string;
};
export type SearchBoxComponentTemplates = Required<Omit<SearchBoxTemplates, 'aiMode'>> & Pick<SearchBoxTemplates, 'aiMode'>;
type SearchBoxProps = {
    placeholder?: string;
