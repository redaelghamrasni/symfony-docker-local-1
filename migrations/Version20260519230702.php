 ...
 */
final class Version20260519230702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_translation (id INT AUTO_INCREMENT NOT NULL, locale VARCHAR(5) NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, article_id INT NOT NULL, INDEX IDX_2EEA2F087294869C (article_id), UNIQUE INDEX UNIQ_2EEA2F087294869C4180C698 (article_id, locale), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
